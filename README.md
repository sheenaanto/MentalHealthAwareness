...
- Leveraged AI to generate content drafts, including mental health awareness text for wellness tip cards and resource links, as well as initial drafts for user stories and the README file.

**Problem Solving & Debugging**;

- AI was used as a tool for fixing CSS layout problems (including centering elements) and ensuring full accessibility by implementing proper ARIA labels. Have also used it to successfully override specific Bootstrap features.
...
AI tools like GitHub Copilot served as an efficient coding partner, helping to speed up development, reduce syntax errors, and learn best practices. However, all code was reviewed, tested, and customized to meet the specific needs of this mental health awareness project.
